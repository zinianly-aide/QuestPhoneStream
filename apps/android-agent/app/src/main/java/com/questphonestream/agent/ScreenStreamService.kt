...
class ScreenStreamService : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        return try {
            ...
            if (projectionData == null) {
                ...
                streamer = WebRtcStreamer(applicationContext, config, resultCode, projectionData, signalingClient!!)
    ...
    private fun startProjectionForeground() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            startForeground(NOTIFICATION_ID, foregroundNotification, ServiceInfo.FOREGROUND_SERVICE_TYPE_MEDIA_PROJECTION)
        } else {
